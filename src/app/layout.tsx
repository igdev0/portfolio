...
export const metadata: Metadata = {
  title: "IGDev | Full-Stack Engineer",
  description:  "IGDev is a full-stack engineer focused on building modern applications and exploring bleeding-edge technologies.",
};
