              ...
              <h1 className="section__title">About me</h1><br/><br/>
                <div className={styles.page__intro}>
                  ...
                  <p>
                    ...
                    on
                    an
                    exciting journey, moving to London in 2015. Driven by a passion for technology, I began teaching
                    myself
                    web
                    programming in 2016 through platforms like Codecademy, Udemy, Pluralsight, FreeCodeCamp, and other
                    resources
                    such as
                  ...
                  <p>
                    By 2022, I achieved a major milestone by signing my first employment contract as a professional
                    software
                  ...
                  <p>
                    In early 2024, I made the deliberate decision to take a well-deserved break to recharge, reconnect
                    with
                    my
                    social life, and embrace the moments that come with closing the chapter on my 20s. It’s been a
                    fulfilling
                    journey so far, and I’m excited about what the future holds as I continue to grow both personally
                    and
                    professionally.
                  </p>
                  ...
                  <p>
                    As I step into the next phase of my journey, I’m eager to embrace new challenges and opportunities
                    that
                    push
                    me to grow both personally and professionally. My focus is on advancing my expertise in software
                    development, particularly in decentralized applications.
                  </p>
                  <p>
                  ...
                  <p>
                    Looking ahead, I aim to combine my technical skills with my curiosity and creativity to build
                    products
                    that
                    not only solve real-world problems but also inspire others. Whether it’s joining a dynamic team,
                    leading
                    new
