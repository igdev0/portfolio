...
const TASK_PATHS = [
    {d: "M1842.01 806.77h43.54v7.44h-43.54z", transform: "rotate(.1 452199.288 -1046398.36)", className: "cls-42"},
    {d: "M1895.43 806.84h13.02v7.44h-13.02z", transform: "translate(-1825.62 -787.9)", className: "cls-42"},
    {d: "M1916.53 806.88h21.1v7.44h-21.1z", transform: "rotate(.1 452262.313 -1046398.414)", className: "cls-42"},
    {d: "M1945.7 806.94h32.32v7.44h-32.32z", transform: "rotate(.1 452296.69 -1046398.444)", className: "cls-42"},
    {d: "M1985.21 807.01h32.32v7.44h-32.32z", transform: "rotate(.1 452336.798 -1046398.48)", className: "cls-42"},
    {d: "M1841.99 818.18h32.32v7.44h-32.32z", transform: "rotate(-179.9 944.325 428.821)", className: "cls-42"},
    {d: "M1881.49 818.24h32.32v7.44h-32.32z", transform: "rotate(-179.9 983.825 428.887)", className: "cls-42"},
    {d: "M1921.89 818.3h21.1v7.44h-21.1z", transform: "rotate(-179.9 1018.615 428.946)", className: "cls-42"},
    {d: "M1951.07 818.35h13.02v7.44h-13.02z", transform: "rotate(180 1043.375 427.9)", className: "cls-42"},
    {d: "M1973.96 818.41h43.54v7.44h-43.54z", transform: "rotate(-179.9 1081.91 429.051)", className: "cls-42"},
    {d: "M1841.97 831.54h43.54v7.44h-43.54z", transform: "rotate(.1 452199.308 -1046375.441)", className: "cls-42"},
    {d: "M1895.39 831.61h13.02v7.44h-13.02z", transform: "rotate(.1 452239.415 -1046375.476)", className: "cls-42"},
    {d: "M1916.48 831.65h21.1v7.44h-21.1z", transform: "rotate(.1 452262.333 -1046375.496)", className: "cls-42"},
    {d: "M1945.66 831.71h32.32v7.44h-32.32z", transform: "rotate(.1 452296.71 -1046375.526)", className: "cls-42"},
    {d: "M1985.16 831.78h32.32v7.44h-32.32z", transform: "rotate(.1 452336.818 -1046375.561)", className: "cls-42"},
]
...
function Task({
    ...
    const [priorityCircleSpringStyle, priorityCircleSpringApi] = useSpring(() => ({
        opacity: 0,
        duration: PRIORTY_BULLET_DURATION
    }));
    const [taskCompleteSpringStyle, taskCompleteSpringApi] = useSpring(() => ({
        opacity: 0,
        duration: PERSON_ALLOCATION
    }));
    ...
    const runSteps = useCallback(async () => {
        ...
        tasksSpringApi,
        PRIORTY_BULLET_DURATION,
        PERSON_ALLOCATION,
        TYPING_DURATION,
        TYPING_WORD_DELAY,
        priorityCircleSpringApi,
        personSpringApi,
        onAnimationComplete
    ])
    useEffect(() => {
