...
import {ContentWrapper, Spacer} from "../styles/helpers";

const META = {title: "Dorultan Ianos - Privacy policy"}
export default function PrivacyPolicy() {
    return (
        <Page meta={META} pageContentTitle="Privacy Policy">
            <ContentWrapper>
                ...
                <ul>
                    <li>
                        <p>By email: <a href="mailto:dorultanianos@gmail.com" >dorultanianos@gmail.com</a>
                        </p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="https://dorultanianos.dev/contact"
                                                                    rel="noreferrer"
                                                                    target="_blank">https://dorultanianos.dev/contact</a>
                        </p>
                    </li>
                </ul>
            </ContentWrapper>
